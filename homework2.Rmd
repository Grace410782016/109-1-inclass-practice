...
# sukiyaMenu3
category<-c("新登場","推薦套餐")
item<-c("番茄牛丼飯","蔥溫玉牛丼套餐")
description<-c("新鮮番茄的酸味，讓人食慾大開!",
               "蔥溫玉牛丼+自選套餐")
price<-c(109,149)
sukiyaMenu3<-list(
                  category=category,
...
```{r ans16}
# sukiyaMenu4
newPromotion<-list(category="新登場",
                   options=list(
                     item=c("番茄牛丼","起司番茄牛丼"),
                     description=c("新鮮番茄的酸味，讓人食慾大開!",
                                    "新鮮番茄的酸味，讓人食慾大開!"),
...
recommend<-list(category="推薦套餐",
                options=list(
                  item=c("外送限定牛丼套餐","蔥溫玉牛丼套餐","3種起司牛丼大餐",
                         "牛肉咖哩飯套餐","燒烤雞肉丼套餐"),
                  description=c("牛丼+外送限定 菜豆、味增湯",
                                "蔥溫玉牛丼+自選套餐","3種起司牛丼+自選套餐",
                                "牛肉咖哩飯+自選套餐","燒烤雞肉丼套餐+自選套餐"),
                  price=c(119,149,149,169,189)
                )
)
sukiyaMenu4<-list(newPromotion,
                  recommend)
```
...
```{r ans22}
# totalAmount
tc<-sukiyaMenu[["雞肉丼類"]][[1]][["product_variations"]][[2]][["price"]]
ta<-sukiyaMenu[["鰻魚丼類"]][[2]][["product_variations"]][[1]][["price"]]
totalAmount<-tc+ta
totalAmount
```
